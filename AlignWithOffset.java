...
public class AlignWithOffset extends Command{
  ...
  public AlignWithOffset(boolean isRightScore, DriveSubsystem m_robotDrive) {
  ...
  public void execute() {
    if (LimelightHelpers.getTV("") && LimelightHelpers.getFiducialID("") == tagID) {
      ...
      m_robotDrive.drive(yController.getError() < Constants.Y_TOLERANCE_REEF_ALIGNMENT ? xSpeed : 0, ySpeed, rotValue, false);
      ...
      if (!rotController.atSetpoint() || !yController.atSetpoint() || !xController.atSetpoint()) {
        ...
        m_robotDrive.drive(new Translation2d(), 0, false);
    }
  }
